...
def upgrade() -> None:
    ...
    op.alter_column('announces', 'thread_id', new_column_name='source_message_id')
    op.create_unique_constraint('announces_source_message_id_key', 'announces', ['source_message_id'])


def downgrade() -> None:
    op.drop_constraint('announces_source_message_id_key', 'announces', type_='unique')
    op.alter_column('announces', 'source_message_id', new_column_name='thread_id')
